# 👋 Hi, I'm Aditya Maisuriya
## Full-Stack ASP.NET Core & C# Developer
...
---
### 🏆 Key Achievements
- ⚡ **99.9% Uptime** achieved on E-Commerce API project
- 📈 **10+ Projects** completed successfully
- 🔄 **RESTful APIs** with efficient caching and load balancing
- 💳 Payment gateway integrations with robust security
- 🎯 Enhanced ERP modules serving multiple clients
---
### 🎓 Education
...
[![Portfolio](https://img.shields.io/badge/-Portfolio-000000?style=flat-square&logo=google-chrome&logoColor=white)](https://adityamaisuriya.pages.dev/)
---
### 🌐 Languages
- 🇬🇧 English - Fluent
- 🇮🇳 Hindi - Fluent
...
- 💬 Ask me about ASP.NET Core, C#, SQL, or Web Development
---
*"Results-driven developer with a passion for creating efficient, scalable solutions"*
---
![Profile Views](https://komarev.com/ghpvc/?username=Adiie0001&color=blue&style=flat-square)
